 ...
 * @since 100.0.2
 */
class VendorProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements IdentityInterface
{
    /**
    ...
    public function getLoadedProductCollection()
    {
        ...
        $searchCriteriaFilter = $this->searchCriteriaBuilder->addFilter('vendor', $id, 'eq')->create();
    ...
    public function getVendorDetails()
    {
        ...
        foreach ($datas as $data){
            if($data->getEntityId()==$id){
                ...
                array_push( $details, $data->getVendorName());
                return $details;
            }
        }
    }
